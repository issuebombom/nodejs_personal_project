...
const { verifyAccessToken, replaceAccessToken } = require('../verification'); // 토큰 검증을 위한 미들웨어
...
// 포스트 삭제하기
postsRouter.delete('/:postId', verifyAccessToken, replaceAccessToken, postsController.deletePosts);
